> Historical plan; superseded by `../astra.md` on 2026-09-06. Preserve its work log and receipts.
...
publication commit `53dae98`, research source `bf79140`. Main/companion HTML, CSS,
public snapshot, publication manifest and four historical videos fetched with HTTP200
and exact export hashes; both live pages pass390 px browser checks without script or
asset errors. The initial release omitted `docs/assets`; the corrected allowlist and
asset-coverage test resolved it in a normal fast-forward update.
[Release receipt](outputs/astra_site_release_v2/receipt.json). The publication checkout is
